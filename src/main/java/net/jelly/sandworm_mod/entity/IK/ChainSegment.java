...
public class ChainSegment extends Entity {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(VISUAL_SCALE, new Vec3(1, 1, 1).toVector3f());
        builder.define(DIR_VEC, new Vec3(0, 2, 0).toVector3f());
        builder.define(UP_VEC, new Vec3(0, 1, 0).toVector3f());
    }
    ...
    public void setVisualScale(Vec3 scaleVec) { entityData.set(VISUAL_SCALE, scaleVec.toVector3f()); }
